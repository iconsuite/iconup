...
function showUploadComplete(data) {
    ...
    if (hasErrors) {
        document.getElementById('upload-status').textContent = 'Upload completato con errori';
        iconEl.textContent = '!';
        iconEl.classList.add('warning');
        titleEl.textContent = 'Completato con errori';
        document.getElementById('complete-message').textContent = `${uploadSuccess} file caricati, ${uploadErrors} errori`;
        retryBtn.style.display = 'inline-flex';
        addLog(`Completato con ${uploadErrors} errori su ${data.total_files} file.`, 'error');
    } else {
        document.getElementById('upload-status').textContent = 'Upload completato!';
        iconEl.textContent = '✓';
        iconEl.classList.remove('warning');
        titleEl.textContent = 'Installazione completata!';

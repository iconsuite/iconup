    ...
    list.innerHTML = profiles.map(p => `
        <div class="profile-item" data-id="${p.id}">
            ...
            <div class="profile-item-actions">
                <button type="button" class="btn-duplicate" title="Duplica"><img class="icon-img" src="assets/duplicate.svg" alt="gear" width="30" height="30"></button>
                <button type="button" class="btn-delete" title="Elimina"><img class="icon-img" src="assets/delete.svg" alt="gear" width="30" height="30"></button>
            </div>
        </div>
    `).join('');
...
function clearForm() {
    ...
    setCustomSelectValue('ftp-protocol-wrapper', 'ftp-protocol', 'sftp');
